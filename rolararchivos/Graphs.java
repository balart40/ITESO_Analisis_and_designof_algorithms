...
public class Graphs {
	...
	public static void main(String[] args) 
	{
		...
		boolean t = true, f = false;
		double[][] graph = initGraph(6,INF);
		setEdge(graph, "A","D", 2.0);
		setEdge(graph, "A","E", 4.0);
		setEdge(graph, "D","E", 3.0);
		setEdge(graph, "D","C", 2.0);
		setEdge(graph, "C","E", 1.0);
		setEdge(graph, "C","F", 3.0);
		setEdge(graph, "C","B", 5.0);
		setEdge(graph, "F","B", 3.0);
		setEdge(graph, "E","F", 4.0);
